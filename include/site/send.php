...
if((isset($_POST['name'])&&$_POST['name']!="")&&(isset($_POST['phone'])&&$_POST['phone']!="")){ //Проверка отправилось ли наше поля name и не пустые ли они
    $to = $_POST['name']; //Почта получателя, через запятую можно указать сколько угодно адресов
    $subject = 'Депеша'; //Загаловок сообщения
    $message = '
...
<table class="body">
                        ...
                        <th class="small-12 large-12 columns first last">
                            <table>
                                <tr>
                                    <th>
                                        <center data-parsed="">
                                            <a href="http://anton-sementsov.bplaced.net" align="center" class="text-center">
                                                <br/>
                                            </a>
                                        </center>
                                    </th>
                    ...
                    <table class="row masthead"><tbody><tr> <!-- Masthead -->
                        <th class="small-12 large-12 columns first last">
                            <table>
                                <tr>
                                    <th>
                                        <h1 class="text-center">Письмо от Антохи</h1>
                                        <center data-parsed="">
                    ...
                    <table class="row"><tbody><tr> <!-- Horizontal Digest Content -->
                        <th class="small-12 large-8 columns first">
                            <table>
                                <tr>
                                    <th>
                                        <b><h5>Тут должен быть заголовок, но лень его придумать</h5></b>
                                        <p>Тут должен быть текст, но для него есть Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                        <p><a href="http://anton-sementsov.bplaced.net">Кликни тутачки &#x203A;</a></p>
                                    </th>
                                </tr>
                            </table>
                        </th>
                        <th class="small-12 large-3 columns last">
                            <table>
                                <tr>
                                    <th>
                                        <img width="15%" src="https://scontent-frt3-2.cdninstagram.com/vp/5b5e8941ffc5f0d36dafb7c5ca19e406/5B4EFE8D/t51.2885-15/s1080x1080/e15/fr/25026350_1788049604823632_6421828177491918848_n.jpg" alt="Feature Image">
                                    </th>
                                </tr>
                            </table>
                        </th>
                                ...
                                <tr>
                                    <th>
                                        <center data-parsed="">
                                            ...
                                            <h5 align="center" class="text-center">Круто! Тута тоже можно кликнуть</h5>
                                            <div class="button">
                                                <!--[if mso]>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:40px;v-text-anchor:middle;width:150px;" arcsize="8%" strokecolor="#f7931d" fillcolor="#f7931d">
                                                    <w:anchorlock/>
                                                    <center style="color:#ffffff;font-family:sans-serif;font-size:16px;font-weight:bold;">Жми, начальник!</center>
                                                </v:roundrect>
                                                <![endif]-->
                                                <a href="http://anton-sementsov.bplaced.net" style="background-color:#f7931d;border:0px solid #f7931d;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">Жми, начальник!</a>
                                            </div>
                    ...
                    <table class="row grey"><tbody><tr>
                        <th class="small-12 large-12 columns first last">
                            <table>
                                <tr>
                                    <th>
                                        <p class="text-center footercopy">&#xA9; А здеся копирайтик и все такое. 2018 Все права под строгим надзором.</p>
                                    </th>
                                    <th class="expander"></th>
                                </tr>
                            </table>
    ...
    $headers .= "From: Anton Sementsov <anton-sementsov@bplaced.net>\r\n"; //Наименование и почта отправителя
